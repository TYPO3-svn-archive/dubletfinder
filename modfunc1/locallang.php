...
$LOCAL_LANG = Array (
	'default' => Array (
		...
		'label_trim' => 'Trim whitespace around e-mail addresses',
		...
		'heading_trim' => 'Trim whitespace around e-mail addresses',
		...
		'verbose_trim' => 'If you have imported e-mail address from another source, there might be whitespace (space, tabs, or linefeeds) at the beginning or the end of the <code>email</code> field. This would mess up the search for duplicates. You can use this function to remove that whitespace first.',
	...
	'de' => Array (
		...
		'label_trim' => 'Whitespace um E-Mail-Adressen entfernen',
		...
		'heading_trim' => 'Whitespace um E-Mail-Adressen entfernen',
		...
		'heading_trimTable' => 'Bereinige E-Mail-Adressen in',
		...
		'verbose_trim' => 'Wenn Sie E-Mail-Adressen von einer anderen Quelle importiert haben, kann es sein, dass sich Whitespace (Spaces, Tabs oder Zeilenumbrüche) am Anfang oder Ende des <code>email</code>-Feldes befindet. Dies würde Probleme bei der Dubletten-Suche verursachen. Mit dieser Funktion können Sie den Whitespace automatisch vor der Suche entfernen.',
